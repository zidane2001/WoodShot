...
('Épicéa Commun', 'Norway spruce wood', 'épicéa', 95.00, 'stère', 110, 'https://res.cloudinary.com/djxiszqgd/image/upload/v1762602455/woodshot/products/image%20copy%207.png', '{"humidity": "17%", "density": "0.45 g/cm³"}', TRUE),
('Aulne Glutineux', 'Alder wood for smoking', 'aulne', 125.00, 'stère', 80, 'https://res.cloudinary.com/djxiszqgd/image/upload/v1762602473/woodshot/products/image%20copy%206.png', '{"humidity": "14%", "density": "0.5 g/cm³"}', TRUE),
('Orme', 'Elm wood for boat building', 'orme', 170.00, 'stère', 55, 'https://res.cloudinary.com/djxiszqgd/image/upload/v1762602449/woodshot/products/imagefond.png', '{"humidity": "13%", "density": "0.55 g/cm³"}', TRUE),
